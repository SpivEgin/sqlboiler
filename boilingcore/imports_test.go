...
func TestCombineTypeImports(t *testing.T) {
	...
	imports1 := imports{
		...
		thirdParty: importList{
			`"github.com/SpivEgin/sqlboiler/boil"`,
		},
	}
...
func TestCombineImports(t *testing.T) {
	...
	a := imports{
		...
		thirdParty: importList{"github.com/SpivEgin/sqlboiler", "gopkg.in/volatiletech/null.v6"},
	}
	b := imports{
		standard:   importList{"os"},
		thirdParty: importList{"github.com/SpivEgin/sqlboiler"},
	}
	...
	if c.thirdParty[0] != "github.com/SpivEgin/sqlboiler" && c.thirdParty[1] != "gopkg.in/volatiletech/null.v6" {
		t.Errorf("Wanted: github.com/SpivEgin/sqlboiler, gopkg.in/volatiletech/null.v6 got: %#v", c.thirdParty)
	}
}
