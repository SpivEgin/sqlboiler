...
[![License](https://img.shields.io/badge/license-BSD-blue.svg)](https://github.com/SpivEgin/sqlboiler/blob/master/LICENSE)
[![GoDoc](https://godoc.org/github.com/SpivEgin/sqlboiler?status.svg)](https://godoc.org/github.com/SpivEgin/sqlboiler)
...
import (
  ...
  . "github.com/SpivEgin/sqlboiler/queries/qm"
)
...
```shell
go get -u -t github.com/SpivEgin/sqlboiler
```
...
import . "github.com/SpivEgin/sqlboiler/queries/qm"
...
For a comprehensive ruleset for `Bind()` you can refer to our [godoc](https://godoc.org/github.com/SpivEgin/sqlboiler/queries#Bind).
...
by using the [boil.Begin()](https://godoc.org/github.com/SpivEgin/sqlboiler/boil#Begin) function.
...
The homepage for the [SQLBoiler](https://github.com/SpivEgin/sqlboiler) [Golang ORM](https://github.com/SpivEgin/sqlboiler)
generator is located at: https://github.com/SpivEgin/sqlboiler

## Benchmarks

If you'd like to run the benchmarks yourself check out our [boilbench](https://github.com/SpivEgin/boilbench) repo.
